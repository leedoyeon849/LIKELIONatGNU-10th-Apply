...
def check_questions():
    ...
    questions: dict = {
        ...
        'q_major': '지원자의 소속, 학과(캠퍼스)을 입력해 주세요.',
        'q_grade': '학년과 학번을 입력해 주세요.',
        'q_track': '2. 멋쟁이사자처럼 대학 10기부터 기초 개발 스터디는 동일하게 진행되지만 이후에 기획/디자인 파트와 개발 파트 중 선택하여 진행하게 됩니다. 어느 파트에 지원하시나요? ① 기획/디자인 파트② 개발 파트',
